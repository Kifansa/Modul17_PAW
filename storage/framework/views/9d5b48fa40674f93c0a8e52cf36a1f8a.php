<?php if(config('sweetalert.alwaysLoadJS') === true || Session::has('alert.config') || Session::has('alert.delete')): ?>
    ...
    <?php endif; ?>
<?php endif; ?>
<?php /**PATH D:\TUGAS\SEMESTER 3\PENGEMBANGAN APLIKASI WEB\Modul 17\aplikasi-pegawai\vendor\realrashid\sweet-alert\src/../resources/views/alert.blade.php ENDPATH**/ ?>